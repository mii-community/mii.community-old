...
export const dictionary: Diction[] = [
  {
    idiom: 'みぃコミュニティ',
    mean:
  ...
  {
    idiom: 'アジアンイングリッシュ',
    mean: 'Asian English の読み間違い。我々の英語がなんたるかを表している。',
  },
  {
    idiom: '緑の悪魔',
    mean: 'LINE のこと。LINE アンチによって勝手に名付けられた。',
  },
  {
    idiom: '紫の悪魔',
    mean:
      'Discord のこと。気づいていながらも Discord に時間を溶かしてしまうことから。',
  },
]
