...
const dictionary: Dictionary[] = [
  ...
  {
    idiom:
      '【一言】ひろすけっていいます。15歳の独身男性。身長は171cmで体重は63kg。趣味は特にないかな。まあ、挙げるとしたら、読書かな。好きなものは、パセリゴーヤレタス。嫌いなものは集団心理。あと、ハーバード大卒。中学校では授業中本しか読んでなかった。友達はいらないから作ってない。ちなみに IQ は 130 より少し上。父親が不動産会社の社長で母がパリの有名上場企業の会長。最近抜け毛が激しいのが悩み。庶民ども、どうぞよろしく。',
