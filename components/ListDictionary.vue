...
const dictionary: Dictionary[] = [
  ...
  },
  {
    idiom: 'みぃ小説',
    mean:
      'みぃメンバーが書いた、猫要素を含めたショートストーリー(の集まりのことも指す)のこと。実はこのサイトのある場所に隠れている。',
  },
  {
    idiom: 'カズカズムーブ',
    mean:
  ...
  },
  {
    idiom: '魔物召喚',
    mean:
      'モンスターエナジーパイプラインパンチと ZONe Utopia を混ぜたもの。飲みすぎに注意。召喚コストは約400円。',
  },
  {
    idiom: 'ニパカブリ…',
    mean:
      'とある生物の名前……ではない。望月よもぎが Apex をプレイ中に、パーティーがかぶっているときに放った。',
  },
  {
    idiom: 'ヨクバリス…',
    mean:
      'とある生物の名前……ではない。相手が欲張りな場面でつぶやく言葉。ヨ…ヨクバリス……',
  },
  {
    idiom: 'リロードの旅',
    mean: 'みぃサイトの隠し要素が、リロードするたびに変わることから。',
  },
]
